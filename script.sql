...
VALUES ("Administrador"), ("Vendedor"), ("Totem");
...
INSERT INTO user(name, name_completed, email, cpf, password, profile_ID) VALUES 
("Patrick Nascimento", "Patrick Pablo Moraes Nascimento", "patrick54682366@edu.pa.senac.br", "07085474270", "$2a$12$7GtaZ5jnLrKUMlyX3vK1i.mEJht0la6Nnd9KoYeOtR993apk8elCu", 1), 
("Irineu da silva", "Irineu vc não sabe e nem eu da silva", "irineudasilva@email.com", "85478952340", "$2a$2a$12$MAYMiwX.KT7/MUgzW4U6kOdoOVl61Iy83kNH8.99g/lPBy/r5gg7q", 1), 
("Patati", "patatipalhaco", "patatipalhaco@email.com", "54741355285", "$2a$2a$12$mmkD75TZzRKK7JdepOVqCOPmop.hbaspgFdgTShXzn4MtL9U6WiIK", 2), 
("patata palhaco", "patatapalhaco", "patatapalhaco@email.com", "58789365810", "$2a$12$Ld/1AmI5OMWDuZhSN88y5Oo8BXU4bR5Lsev2SsTrDJjDnt5zPhdy6", 2),
("fulano santos", "fulano santos santos", "fulanosantos@email.com", "15879845270", "$12$AN88VIOBz4mHZ3ZAtOO.XO9mdQ15ovz/XYKLlQwokxZxhKJwJ8RFu", 3);

SELECT * FROM user;

SELECT user.name_completed, profile.nome FROM user INNER JOIN profile ON user.ID = profile.ID;
...
INSERT INTO event(event_name, limit_peaple, date_event, hour_event, description, user_ID)
VALUE ("O grande evento", 5000, "2025-09-20", "20:00:00", "O grande evento da cantora liza no Senac Music Hall - DF", 1);
...
("Público geral", 4500, 45.00, 1), ("Convidados VIP", 50, 100.00, 1), ("Imprensa", 450, 00.00, 1);
...
("Seu madruga", "seumadruga@email.com", "58065478070"),
("Mestre Ioda", "mestreioda@email.com", "47458265810"),
("Javascript da Silva", "javascriptdasilva@email.com", "58065787010"),
("pythonjr", "pythonjr@email.com", "87069845311"),
("Pica Pau", "picapau@email.com", "87458247980");
...
(5, 1, 3, "gfsgs541sdgsd", "2025-07-15 17:30:00"),
(2, 1, 1, "gfsgs541sdtes", "2025-07-25 03:11:00"),
(1, 1, 2, "gfsgs541sddeg", "2025-07-05 12:08:30"),
(5, 1, 2, "gfsgs541sdyrs", "2025-07-15 23:15:20"),
(3, 1, 3, "gfsgs541sdfdf", "2025-07-15 13:45:50");
